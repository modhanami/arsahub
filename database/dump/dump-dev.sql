...
1	2	1	300	2023-11-25 15:49:18.301626+07	2023-12-16 15:51:34.206813+07
\.
...
COPY public.rule (rule_id, title, description, activity_id, created_at, updated_at, trigger_id, trigger_type_id, action_id, trigger_type_params, action_params, trigger_params, rule_activation_type_id) FROM stdin;
7	Workshop Score reached 50 then Give 1000 point	\N	1	2023-12-16 14:42:59.346971+07	2023-12-16 14:42:59.346971+07	43	\N	1	\N	{"value": "0"}	{"value": "50"}	2
10	When Workshop Score Reached 50, Give 100 points	\N	1	2023-12-16 15:22:20.461599+07	2023-12-16 15:22:20.461599+07	44	\N	1	\N	{"value": "100"}	{"value": "50"}	2
\.
...
COPY public.rule_progress_times (rule_progress_times_id, rule_id, app_user_activity_id, progress, created_at, updated_at, completed_at) FROM stdin;
1	10	1	1	2023-12-16 15:51:34.219812+07	2023-12-16 15:51:34.219812+07	2023-12-16 15:51:34.216811+07
\.
...
SELECT pg_catalog.setval('public.trigger_custom_unit_trigger_custom_unit_seq', 2, true);
...
CREATE INDEX idx_16462_user_activity_id ON public.rule_progress_times USING btree (app_user_activity_id);
...
ALTER TABLE ONLY public.rule_progress_times
    ADD CONSTRAINT rule_progress_times_ibfk_2 FOREIGN KEY (app_user_activity_id) REFERENCES public.app_user_activity(app_user_activity_id);
