...
--
-- Name: action_effect_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.action ALTER COLUMN effect_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.action_effect_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: external_system_external_system_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.external_system ALTER COLUMN external_system_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.external_system_external_system_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: integration_template; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.integration_template (
    name text NOT NULL,
    description text,
...
ALTER TABLE public.integration_template OWNER TO postgres;

--
-- Name: integration_template_integration_template_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.integration_template_integration_template_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.integration_template_integration_template_id_seq OWNER TO postgres;

--
-- Name: integration_template_integration_template_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.integration_template_integration_template_id_seq OWNED BY public.integration_template.integration_template_id;
...
--
-- Name: trigger_template_integration_tempalte_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.trigger_template_integration_tempalte_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.trigger_template_integration_tempalte_id_seq OWNER TO postgres;

--
-- Name: trigger_template_integration_tempalte_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.trigger_template_integration_tempalte_id_seq OWNED BY public.trigger_template.trigger_template_id;
...
--
-- Name: user_activity_achievement; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.user_activity_achievement (
...
ALTER TABLE public.user_activity_achievement OWNER TO postgres;

--
-- Name: user_activity_achievement_user_activity_achievement_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.user_activity_achievement ALTER COLUMN user_activity_achievement_id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: user_activity_point_history; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.user_activity_point_history (
...
ALTER TABLE public.user_activity_point_history OWNER TO postgres;

--
-- Name: user_activity_point_history_user_activity_point_history_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.user_activity_point_history ALTER COLUMN user_activity_point_history_id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: user_activity_progress; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.user_activity_progress OWNER TO postgres;

--
-- Name: user_activity_progress_user_activity_progress_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.user_activity_progress ALTER COLUMN user_activity_progress_id ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE public.user_activity ALTER COLUMN user_activity_id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: integration_template integration_template_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.integration_template ALTER COLUMN integration_template_id SET DEFAULT nextval('public.integration_template_integration_template_id_seq'::regclass);
...
ALTER TABLE ONLY public.trigger_template ALTER COLUMN trigger_template_id SET DEFAULT nextval('public.trigger_template_integration_tempalte_id_seq'::regclass);
...
COPY public.action (effect_id, title, description, json_schema, created_at, updated_at, key) FROM stdin;
...
COPY public.activity (activity_id, title, description, created_at, updated_at, external_system_id) FROM stdin;
...
COPY public.external_system (external_system_id, title, description, api_key, created_at, updated_at, created_by) FROM stdin;
...
--
-- Data for Name: integration_template; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.integration_template (name, description, integration_id, integration_template_id) FROM stdin;
...
COPY public.rule (rule_id, title, description, activity_id, created_at, updated_at, trigger_id, trigger_type_id, effect_id, trigger_type_params, effect_params, trigger_params) FROM stdin;
...
COPY public.rule_template (rule_template_id, name, description, trigger_template_id, action_id, external_system_id, created_at, updated_at, effect_params, trigger_params) FROM stdin;
...
COPY public.trigger (trigger_id, title, description, created_at, updated_at, key, json_schema, integration_id) FROM stdin;
...
COPY public.trigger_template (title, description, key, json_schema, integration_template_id, trigger_template_id) FROM stdin;
Complete activity	Trigger when an activity is completed	completed_activity	\N	1	14
Share activity	Trigger when an activity is shared	shared_activity	\N	1	15
Join activity	Trigger when a user joins an activity	joined_activity	\N	1	16
Check in	Trigger when a user checks in to an activity	checked_in	\N	1	17
\.
...
COPY public."user" (user_id, username, name, external_user_id, external_system_id, created_at, updated_at) FROM stdin;
...
COPY public.user_activity (user_activity_id, user_id, activity_id, points, created_at, updated_at) FROM stdin;
1	1	1	1385	2023-11-25 15:49:18.301626+07	2023-11-28 23:03:47.043939+07
\.


--
-- Data for Name: user_activity_achievement; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.user_activity_achievement (user_activity_achievement_id, achievement_id, user_activity_id, completed_at, created_at, updated_at) FROM stdin;
...
--
-- Data for Name: user_activity_point_history; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.user_activity_point_history (user_activity_point_history_id, user_activity_id, activity_id, points, created_at, description) FROM stdin;
\.


--
-- Data for Name: user_activity_progress; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.user_activity_progress (user_activity_progress_id, activity_id, user_activity_id, unit_id, progress_value, created_at, updated_at) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.achievement_achievement_id_seq', 2, true);
...
--
-- Name: action_effect_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.action_effect_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.activity_activity_id_seq', 7, true);
...
--
-- Name: external_system_external_system_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.external_system_external_system_id_seq', 24, true);


--
-- Name: integration_template_integration_template_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.integration_template_integration_template_id_seq', 1, true);
...
--
-- Name: trigger_template_integration_tempalte_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.trigger_template_integration_tempalte_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.trigger_trigger_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.user_activity_user_activity_id_seq', 1, true);
...
--
-- Name: user_activity_achievement idx_16400_primary; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_activity_achievement
...
--
-- Name: user_activity idx_16425_primary; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_activity_point_history idx_16432_primary; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_activity_point_history
...
--
-- Name: external_system idx_16500_primary; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: integration_template integration_template_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.integration_template
    ADD CONSTRAINT integration_template_pk PRIMARY KEY (integration_template_id);
...
--
-- Name: user_activity_progress user_activity_progress_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_activity_progress
...
CREATE INDEX idx_16400_achievement_id ON public.user_activity_achievement USING btree (achievement_id);
...
CREATE INDEX idx_16425_activity_id ON public.user_activity USING btree (activity_id);
...
CREATE INDEX idx_16425_user_id ON public.user_activity USING btree (user_id);
...
CREATE INDEX idx_16432_activity_id ON public.user_activity_point_history USING btree (activity_id);
...
CREATE INDEX idx_16432_user_activity_id ON public.user_activity_point_history USING btree (user_activity_id);
...
--
-- Name: idx_16438_effect_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_16438_effect_id ON public.rule USING btree (effect_id);
...
--
-- Name: idx_16492_external_user_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX idx_16492_external_user_id ON public."user" USING btree (external_user_id);
...
ALTER TABLE ONLY public.activity
    ADD CONSTRAINT activity_fk FOREIGN KEY (external_system_id) REFERENCES public.external_system(external_system_id);


--
-- Name: external_system external_system_user_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.external_system
    ADD CONSTRAINT external_system_user_user_id_fk FOREIGN KEY (created_by) REFERENCES public."user"(user_id);


--
-- Name: integration_template integration_template_external_system_external_system_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.integration_template
    ADD CONSTRAINT integration_template_external_system_external_system_id_fk FOREIGN KEY (integration_id) REFERENCES public.external_system(external_system_id);
...
ALTER TABLE ONLY public.rule
    ADD CONSTRAINT rule_ibfk_4 FOREIGN KEY (effect_id) REFERENCES public.action(effect_id);
...
ALTER TABLE ONLY public.rule_progress_streak
    ADD CONSTRAINT rule_progress_streak_ibfk_2 FOREIGN KEY (user_activity_id) REFERENCES public.user_activity(user_activity_id);
...
ALTER TABLE ONLY public.rule_progress_times
    ADD CONSTRAINT rule_progress_times_ibfk_2 FOREIGN KEY (user_activity_id) REFERENCES public.user_activity(user_activity_id);


--
-- Name: rule_template rule_template_action_effect_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rule_template
    ADD CONSTRAINT rule_template_action_effect_id_fk FOREIGN KEY (action_id) REFERENCES public.action(effect_id);


--
-- Name: rule_template rule_template_external_system_external_system_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rule_template
    ADD CONSTRAINT rule_template_external_system_external_system_id_fk FOREIGN KEY (external_system_id) REFERENCES public.external_system(external_system_id);
...
--
-- Name: trigger trigger_external_system_external_system_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.trigger
    ADD CONSTRAINT trigger_external_system_external_system_id_fk FOREIGN KEY (integration_id) REFERENCES public.external_system(external_system_id);


--
-- Name: trigger_template trigger_template_external_system_external_system_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.trigger_template
    ADD CONSTRAINT trigger_template_external_system_external_system_id_fk FOREIGN KEY (integration_template_id) REFERENCES public.integration_template(integration_template_id);


--
-- Name: user_activity_achievement user_activity_achievement_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_activity_achievement user_activity_achievement_ibfk_2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_activity_achievement
    ADD CONSTRAINT user_activity_achievement_ibfk_2 FOREIGN KEY (user_activity_id) REFERENCES public.user_activity(user_activity_id);


--
-- Name: user_activity user_activity_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_activity
    ADD CONSTRAINT user_activity_ibfk_1 FOREIGN KEY (user_id) REFERENCES public."user"(user_id);


--
-- Name: user_activity user_activity_ibfk_2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_activity
    ADD CONSTRAINT user_activity_ibfk_2 FOREIGN KEY (activity_id) REFERENCES public.activity(activity_id);


--
-- Name: user_activity_point_history user_activity_point_history_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_activity_point_history
    ADD CONSTRAINT user_activity_point_history_ibfk_1 FOREIGN KEY (user_activity_id) REFERENCES public.user_activity(user_activity_id);


--
-- Name: user_activity_point_history user_activity_point_history_ibfk_2; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_activity_progress user_activity_progress_activity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_activity_progress user_activity_progress_unit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: user_activity_progress user_activity_progress_user_activity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_activity_progress
    ADD CONSTRAINT user_activity_progress_user_activity_id_fkey FOREIGN KEY (user_activity_id) REFERENCES public.user_activity(user_activity_id);


--
-- Name: user user_ibfk_1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."user"
    ADD CONSTRAINT user_ibfk_1 FOREIGN KEY (external_system_id) REFERENCES public.external_system(external_system_id);
