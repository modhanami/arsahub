...
(
    ...
    rule_activation_type_id bigint                                 not null
        constraint rule_rule_activation_type_rule_type_id_fk
...
(
    rule_progress_times_id bigint generated by default as identity
    ...
    app_user_id            bigint
        constraint rule_progress_times_app_user_app_user_id_fk
        references app_user
);

alter sequence rule_progress_times_rule_progress_single_id_seq owned by rule_progress_times.rule_progress_times_id;
