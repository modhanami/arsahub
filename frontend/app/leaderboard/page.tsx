    ...
    <article className="container mx-auto px-4 sm:px-8">
      <div className="py-8">
        <p className="text-2xl font-semibold mb-4 text-center">
          <ThemeToggle /> Leaderboard [Animate list re-ordering]{" "}
        </p>
        <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
          <div className="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
            <Table className="min-w-full leading-normal">
              <TableHeader>
                <TableRow>
                  <TableHead className="px-5 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold uppercase tracking-wider">
                    Rank
                  </TableHead>
                  <TableHead className="px-5 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold uppercase tracking-wider">
                    Name
