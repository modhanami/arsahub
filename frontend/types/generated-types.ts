...
export interface User extends AuditedEntity, ManagedEntity, PersistentAttributeInterceptable, ExtendedSelfDirtinessTracker {
    username: string;
    name: string;
...
export interface UserActivity extends AuditedEntity, ManagedEntity, PersistentAttributeInterceptable, ExtendedSelfDirtinessTracker {
    user: User | null;
...
export interface Activity extends AuditedEntity, ManagedEntity, PersistentAttributeInterceptable, ExtendedSelfDirtinessTracker {
    title: string;
    description: string | null;
    app: App | null;
    rules: Rule[];
...
export interface UserActivityAchievement extends ManagedEntity, PersistentAttributeInterceptable, SelfDirtinessTracker {
...
export interface UserActivityProgress extends AuditedEntity, ManagedEntity, PersistentAttributeInterceptable, SelfDirtinessTracker {
    activity: Activity | null;
    userActivity: UserActivity | null;
...
export interface UserActivityPointHistory extends ManagedEntity, PersistentAttributeInterceptable, SelfDirtinessTracker {
    userActivity: UserActivity | null;
    activity: Activity | null;
    points: number | null;
    description: string | null;
...
export interface CustomUnit extends AuditedEntity, ManagedEntity, PersistentAttributeInterceptable, ExtendedSelfDirtinessTracker {
    name: string | null;
    key: string | null;
    userActivityProgresses: UserActivityProgress[];
    id: number | null;
...
export interface TriggerType extends AuditedEntity, ManagedEntity, PersistentAttributeInterceptable, ExtendedSelfDirtinessTracker {
    title: string | null;
    description: string | null;
    jsonSchema: { [index: string]: any } | null;
    rules: Rule[];
...
export interface Action extends AuditedEntity, ManagedEntity, PersistentAttributeInterceptable, ExtendedSelfDirtinessTracker {
    title: string | null;
    description: string | null;
    jsonSchema: { [index: string]: any } | null;
    rules: Rule[];
