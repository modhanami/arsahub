...
export function TriggerCreateForm() {
  ...
  async function onSubmit(values: FormData) {
    setIsCreating(true);
    const autoGeneratedKey = form.watch("title") && convertTitleToKey(form.watch("title"));
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <p className="text-gray-500 text-sm">
                This is the key that you will use to trigger for users in this activity.
              </p>
              <Input
                value={form.watch("title") && convertTitleToKey(form.watch("title"))}
                readOnly
                disabled
              />
